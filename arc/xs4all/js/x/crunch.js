...
//*****************************************************************************
//doeke@zanstra.net: altered crunch method.
//original: http://www.brainjar.com/js/crunch/ 

var literalStrings;  // For temporary storage of literal strings.

function crunch(s) {
  s = replaceLiteralStrings(s);
  s = removeComments(s);
  s = compressWhiteSpace(s);
  s = combineLiteralStrings(s);
  return restoreLiteralStrings(s);
}
