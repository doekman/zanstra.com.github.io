...
//--| Init stuff |--------------------------------------------------------------
ImageData.prototype.setImage=function(url,lockAsra) {
  this._set("url",url);
  if(typeof lockAsra=="boolean") {
    this.setLockAsra(lockAsra);  
  }
}
//--| Size |--------------------------------------------------------------------
