...
(function()
{
    ...
    function createFrame()
    {
        ...
        window.onFirebugReady = function(doc)
        {
            ...
            addEvent(doc, isIE || isSafari || isCamino ? "keydown" : "keypress", onKeyDown);
    ...
    {
        if (event.keyCode == 123|| (event.keyCode==13 && event.shiftKey)) //F12
            toggleConsole();
    ...
    addEvent(document, isIE || isSafari || isCamino ? "keydown" : "keypress", onKeyDown);
